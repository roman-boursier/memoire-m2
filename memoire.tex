...
\begin{center}
  ...
  \begin{tabular}{ccc}
    ...
    (a)&(b)&(c)
  \end{tabular}
  \captionof{figure}{Dessin de paysages réalisés par des personnes différentes. On note que les niveaux d'informations sont plus ou moins élevés. Le dessin (b) est très abstrait tandis que nous possédons plus de détails au niveau de (a) .\label{fig-croquis}}
\end{center}
