...
Malgré nos recherches, nous n'avons à ce jour trouvé aucun modèle nous permettant de réaliser totalement notre projet.


Notre objectif est donc de reconstruire une image crédible à partir d'une abstraction.
Notre idée est de décomposé le processus d'apprentissage en plusieurs étapes, car comme vu la distance entre une abstraction et une peinture chinoise est trop grande. 
...
\section{Abstraction vers dessins}
- Fait main -> paysage réaliste
- HED
- Ramer–Douglas–Peucker algorithm

\section{Dessins vers peinture}
